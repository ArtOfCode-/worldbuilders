...
<html>
<head>
	<title>Worldbuilders | Page Not Found</title>
	...
	<div class="container">
		...
		<div class="content">
			<div class="main-content">
				<h3>404</h3>
				<img src="/images/underconstruction.png" height="100" width="400" /><br/>
				Sorry, the page you requested (<?php echo basename($_SERVER["REQUEST_URI"]); ?>) could not be found. Either it doesn't exist or is currently undergoing maintenance. Please try again later.
			</div>
			<div class="sidebar">
				<?php
					if(isLoggedIn()) { ?>
