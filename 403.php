...
<html>
<head>
	<title>Worldbuilders | Access Denied</title>
	...
	<div class="container">
		...
		<div class="content">
			<div class="main-content">
				<h3>403</h3>
				Sorry, the page you requested (/<?php echo basename($_SERVER["REQUEST_URI"]); ?>) could not be returned because access to it has been denied.
			</div>
			<div class="sidebar">
				<?php
					if(isLoggedIn()) { ?>
